...
import { preloaderWords } from '../data/preloader_words';
import { useTimeOut } from '../hooks/use_time_out';
import { useDimensions } from '../hooks/use_diamension';
      ...
      {width > 0 ? (
        <>
          <MotionComponent
            ...
            animate='enter'
          >
            <Dot size={48} className='me-3 text-white' />
            <p className='text-white'>{preloaderWords[index]}</p>
          </MotionComponent>
